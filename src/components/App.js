...
export default class App extends Component {
  ...
  saveSound(newSound) {
      ...
      this.setState({
          updatedSound: [...this.state.updatedSound, newSound]
      })
      console.log(this.state.updatedSound);
      
  }

  playClicked() {
    const audioElm = this.audioHandler.current;
    audioElm.src = this.state.updatedSound.shift()
  ...
  render() {
    return (
      <div className="drum" id="drum-machine">
        ...
        <div className="drum-pad"  onClick={this.playClicked}>
        <audio className="clip"
         onEnded={this.playClicked} 
